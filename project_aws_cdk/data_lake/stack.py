...
from project_aws_cdk.data_lake.base import BaseDataLakeBucket, DataLakeLayer
...
class DataLakeStack(core.Stack):
    def __init__(self, scope: core.Construct, **kwargs) -> None:
        ...
        self.data_lake_staged_bucket = BaseDataLakeBucket(self, layer=DataLakeLayer.STAGED)
        self.data_lake_curated_bucket = BaseDataLakeBucket(self, layer=DataLakeLayer.CURATED)
